...
export default function CamerasPage() {
  return (
    <div className="space-y-5">
      <div>
        <p className="text-xs uppercase tracking-[0.18em] text-[#d4a64a]">Monitoring Infrastructure</p>
        <h1 className="mt-2 text-2xl font-medium tracking-tight text-slate-100">Cameras</h1>
      </div>
